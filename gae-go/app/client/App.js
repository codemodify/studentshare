...
App.Forums.AddNewBorrow = function (id) {
    jQuery("#App-AddNew-Sell-AddButton").click(function () {
        ...
        var type  = jQuery("#App-AddNew-Sell-Type").val().toLowerCase();
...
App.Forums.WantRouter = function (id) {
    ...
    if ( (ownerId !== App.Auth.UserId) && (App.Auth.Email === "" || App.Auth.Email === null || App.Auth.Email === undefined) ) {
    	...
    	if (confirmation === true) {
            ...
            jQuery("#App-SettingsDialog-OkButton").click(function (e) {
                ...
                var service = "http://" + window.location.host + "/UpdateUserProfile/" + App.Auth.UserId + "/" + jQuery.base64.encode(email);
